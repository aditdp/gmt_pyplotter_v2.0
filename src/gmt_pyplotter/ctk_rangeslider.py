...
class CustomDrawEngine:
    ...
    preferred_drawing_method: str = (
        "font_shapes"  # 'polygon_shapes', 'font_shapes', 'circle_shapes'
    )

    def __init__(self, canvas: CTkCanvas):
        self._canvas = canvas

    def _DrawEngine__draw_rounded_rect_with_border_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if border_width > 0:
            if corner_radius > 0:
                ...
                if (
                    not self._canvas.find_withtag("border_oval_1_a")
                    and "border_oval_1" not in exclude_parts
                ):
                    ...
                    self._canvas.find_withtag("border_oval_1_a")
                    and "border_oval_1" in exclude_parts
                ):
                    self._canvas.delete("border_oval_1_a", "border_oval_1_b")

                if (
                    not self._canvas.find_withtag("border_oval_2_a")
                    and width > 2 * corner_radius
                    and "border_oval_2" not in exclude_parts
                ):
                    self._canvas.create_aa_circle(
                        0,
                        0,
                ...
                if (
                    not self._canvas.find_withtag("border_oval_3_a")
                    and height > 2 * corner_radius
                    and width > 2 * corner_radius
                    and "border_oval_3" not in exclude_parts
                ):
                    self._canvas.create_aa_circle(
                        0,
                        0,
                    ...
                    not (height > 2 * corner_radius and width > 2 * corner_radius)
                    or "border_oval_3" in exclude_parts
                ):
                    self._canvas.delete("border_oval_3_a", "border_oval_3_b")

                if (
                    not self._canvas.find_withtag("border_oval_4_a")
                    and height > 2 * corner_radius
                    and "border_oval_4" not in exclude_parts
                ):
                    self._canvas.create_aa_circle(
                        0,
                        0,
                ...
                self._canvas.coords(
                    "border_oval_1_a", corner_radius, corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_1_b", corner_radius, corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_2_a",
                    width - corner_radius,
                ...
                self._canvas.delete(
                    "border_corner_part"
                )  # delete border corner parts if not needed
            ...
            self._canvas.coords(
                "border_rectangle_1", (0, corner_radius, width, height - corner_radius)
            )
            self._canvas.coords(
                "border_rectangle_2", (corner_radius, 0, width - corner_radius, height)
            )
        ...
        if inner_corner_radius > 0:
            ...
            if (
                not self._canvas.find_withtag("inner_oval_1_a")
                and "inner_oval_1" not in exclude_parts
            ):
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_1_a", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_1_b", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                    angle=180,
                )
                requires_recoloring = True
            elif (
                self._canvas.find_withtag("inner_oval_1_a")
                and "inner_oval_1" in exclude_parts
            ):
                self._canvas.delete("inner_oval_1_a", "inner_oval_1_b")

            if (
                not self._canvas.find_withtag("inner_oval_2_a")
                and width - (2 * border_width) > 2 * inner_corner_radius
                and "inner_oval_2" not in exclude_parts
            ):
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_2_a", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_2_b", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                    angle=180,
                )
                requires_recoloring = True
            elif self._canvas.find_withtag("inner_oval_2_a") and (
                not width - (2 * border_width) > 2 * inner_corner_radius
                or "inner_oval_2" in exclude_parts
            ):
                self._canvas.delete("inner_oval_2_a", "inner_oval_2_b")

            if (
                not self._canvas.find_withtag("inner_oval_3_a")
                and height - (2 * border_width) > 2 * inner_corner_radius
                and width - (2 * border_width) > 2 * inner_corner_radius
                and "inner_oval_3" not in exclude_parts
            ):
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_3_a", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_3_b", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                    angle=180,
                )
                requires_recoloring = True
            ...
            if (
                not self._canvas.find_withtag("inner_oval_4_a")
                and height - (2 * border_width) > 2 * inner_corner_radius
                and "inner_oval_4" not in exclude_parts
            ):
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_4_a", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                    0,
                    tags=("inner_oval_4_b", "inner_corner_part", "inner_parts"),
                    anchor=tkinter.CENTER,
                    angle=180,
                )
                requires_recoloring = True
                ...
                or "inner_oval_4" in exclude_parts
            ):
            ...
            self._canvas.delete(
                "inner_corner_part"
            )  # delete inner corner parts if not needed
        ...
        if not self._canvas.find_withtag("inner_rectangle_1"):
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("inner_rectangle_1", "inner_rectangle_part", "inner_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag(
            "inner_rectangle_2"
        ) and inner_corner_radius * 2 < height - (border_width * 2):
            self._canvas.create_rectangle(
                0,
                0,
                0,
                0,
                tags=("inner_rectangle_2", "inner_rectangle_part", "inner_parts"),
                width=0,
            )
            requires_recoloring = True

        elif self._canvas.find_withtag(
            "inner_rectangle_2"
        ) and not inner_corner_radius * 2 < height - (border_width * 2):
    ...
    def draw_rounded_slider_with_border_and_2_button(
        ...
        if (
            corner_radius > width / 2 or corner_radius > height / 2
        ):  # restrict corner_radius if it's too larger
            corner_radius = min(width / 2, height / 2)

        if (
            button_corner_radius > width / 2 or button_corner_radius > height / 2
        ...
        corner_radius = DrawEngine._DrawEngine__calc_optimal_corner_radius(
            self, corner_radius
        ...
        if (
            ...
            or self.preferred_drawing_method == "circle_shapes"
        ):
            return self.__draw_rounded_slider_with_border_and_2_button_polygon_shapes(
                width,
                height,
                corner_radius,
                border_width,
            ...
            return self.__draw_rounded_slider_with_border_and_2_button_font_shapes(
                width,
                height,
                corner_radius,
                border_width,
    ...
    def __draw_rounded_slider_with_border_and_2_button_polygon_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        requires_recoloring = DrawEngine._DrawEngine__draw_rounded_progress_bar_with_border_polygon_shapes(
            self,
            width,
            height,
            corner_radius,
        ...
        if not self._canvas.find_withtag("slider_parts"):
            self._canvas.create_polygon(
                (0, 0, 0, 0),
                tags=("slider_line_1", "slider_parts", "slider_0_parts"),
                joinstyle=tkinter.ROUND,
            )
            self._canvas.create_polygon(
                (0, 0, 0, 0),
                tags=("slider_2_line_1", "slider_parts", "slider_1_parts"),
                joinstyle=tkinter.ROUND,
            )
        ...
        if corner_radius <= border_width:
            bottom_right_shift = (
                -1
            )  # weird canvas rendering inaccuracy that has to be corrected in some cases
        else:
        ...
        if orientation == "w":
            ...
            self._canvas.coords(
                "slider_line_1",
                slider_x_position - (button_length / 2),
                button_corner_radius,
                slider_x_position + (button_length / 2),
                button_corner_radius,
                slider_x_position + (button_length / 2),
            ...
            slider_x_position = (
                corner_radius
                + (button_length / 2)
                + (width - 2 * corner_radius - button_length) * slider_2_value
            )
            self._canvas.coords(
                "slider_2_line_1",
                slider_x_position - (button_length / 2),
            ...
            self._canvas.itemconfig("slider_2_line_1", width=button_corner_radius * 2)
        elif orientation == "s":
            slider_y_position = (
                corner_radius
                + (button_length / 2)
                + (height - 2 * corner_radius - button_length) * (1 - slider_value)
            )
            self._canvas.coords(
                "slider_line_1",
                button_corner_radius,
                slider_y_position - (button_length / 2),
                button_corner_radius,
                slider_y_position + (button_length / 2),
            ...
            slider_y_position = (
                corner_radius
                + (button_length / 2)
                + (height - 2 * corner_radius - button_length) * (1 - slider_2_value)
            )
            self._canvas.coords(
                "slider_2_line_1",
                button_corner_radius,
    ...
    def __draw_rounded_slider_with_border_and_2_button_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if (
            not self._canvas.find_withtag("slider_oval_4_a")
            ...
            and not height > 2 * button_corner_radius
        ):
            self._canvas.delete("slider_oval_4_a", "slider_oval_4_b")

        if (
            not self._canvas.find_withtag("slider_oval_3_a")
            and button_length > 0
            and height > 2 * button_corner_radius
        ):
            self._canvas.create_aa_circle(
        ...
        if (
            not self._canvas.find_withtag("slider_rectangle_2")
            and height > 2 * button_corner_radius
        ):
            self._canvas.create_rectangle(
                0,
        ...
        if (
            not self._canvas.find_withtag("slider_oval_2_4_a")
            and height > 2 * button_corner_radius
        ):
            self._canvas.create_aa_circle(
                0,
            ...
            self._canvas.find_withtag("slider_oval_2_4_a")
            and not height > 2 * button_corner_radius
        ):
            self._canvas.delete("slider_oval_2_4_a", "slider_oval_2_4_b")

        if (
            not self._canvas.find_withtag("slider_oval_2_3_a")
            and button_length > 0
            and height > 2 * button_corner_radius
        ):
            self._canvas.create_aa_circle(
            ...
            requires_recoloring = True
        elif self._canvas.find_withtag("border_oval_2_3_a") and not (
            button_length > 0 and height > 2 * button_corner_radius
        ):
        ...
        if not self._canvas.find_withtag("slider_rectangle_2_1") and button_length > 0:
            ...
            self._canvas.find_withtag("slider_rectangle_2_1") and not button_length > 0
        ):
            self._canvas.delete("slider_rectangle_2_1")

        if (
            not self._canvas.find_withtag("slider_rectangle_2_2")
            and height > 2 * button_corner_radius
        ):
            self._canvas.create_rectangle(
                0,
            ...
            self._canvas.find_withtag("slider_rectangle_2_2")
            and not height > 2 * button_corner_radius
        ):
...
class CTkRangeSlider(CTkBaseClass):
    ...
    def __init__(
        ...
        command: Union[
            Callable[[float], None],
            Tuple[Callable[[float], None], Callable[[float], None]],
            None,
        ] = None,
        ...
        **kwargs,
        ...
        self._fg_color = (
            ThemeManager.theme["CTkSlider"]["fg_color"]
            if fg_color is None
        ...
        # shape
        self._corner_radius = (
            ThemeManager.theme["CTkSlider"]["corner_radius"]
        ...
        self._border_width = (
            ThemeManager.theme["CTkSlider"]["border_width"]
        ...
        self._output_values = self._from_ + (
            self._values[0] * (self._to - self._from_)
        ...
        if self._variables is not None:
            self._variable_callback_name[0] = self._variables[0].trace_add(
                "write", self._variable_callback
            )
            self._variable_callback_name[1] = self._variables[1].trace_add(
                "write", self._variable_callback
            )
            self._variable_callback_blocked = True
            self.set(
                [self._variables[0].get(), self._variables[1].get()],
    ...
    def _draw(self, no_color_updates=False):
        ...
        requires_recoloring = (
            self._draw_engine.draw_rounded_slider_with_border_and_2_button(
    ...
    def _clicked(self, event=None):
        if self._state == "normal":
            ...
            if self._orientation.lower() == "horizontal":
                ...
                if clickPos < self._values[0] or abs(clickPos - self._values[0]) < abs(
                    clickPos - self._values[1]
                ):
                ...
                clickPos = 1 - self._reverse_widget_scaling(
                    event.y / self._current_height
                )
                if clickPos < self._values[0] or abs(clickPos - self._values[0]) < abs(
                    clickPos - self._values[1]
                ):
            ...
            self._values = [max(min(x, 1.0), 0.0) for x in self._values]

            self._output_values = (
                self._round_to_step_size(
            ...
            self._values = (self._output_values[0] - self._from_) / (
                self._to - self._from_
            ...
            if self._variables is not None:
                ...
                self._variables[0].set(
                    round(self._output_values[0])
                    if isinstance(self._variables[0], tkinter.IntVar)
                    else self._output_values[0]
                )
                self._variables[1].set(
                    round(self._output_values[1])
                    if isinstance(self._variables[1], tkinter.IntVar)
                    else self._output_values[1]
                )
                self._variable_callback_blocked = False
    ...
    def _on_enter(self, event=0):
        if self._state == "normal":
            ...
            if self._orientation.lower() == "horizontal":
                ...
                if enterPos < self._values[0] or abs(enterPos - self._values[0]) <= abs(
                    enterPos - self._values[1]
                ):
                ...
                enterPos = 1 - self._reverse_widget_scaling(
                    event.y / self._current_height
                )
                if enterPos < self._values[0] or abs(enterPos - self._values[0]) <= abs(
                    enterPos - self._values[1]
    ...
    def _round_to_step_size(self, values):
        if self._number_of_steps is not None:
            ...
            if type(values) is list:
                values = [
                    self._to - (round((self._to - x) / step_size) * step_size)
                    for x in values
                ]
                print(f"values list = {values}")
            else:
                values = round(
                    self._to - (round((self._to - values) / step_size) * step_size), 1
                )
                print(f"values not list = {values}")
            return values
        else:
            print(f"values else = {values}")
            return values
    ...
    def configure(self, require_redraw=False, **kwargs):
        ...
        if "progress_color" in kwargs:
            self._progress_color = self._check_color_type(
                kwargs.pop("progress_color"), transparency=True
            )
            require_redraw = True
        ...
        if "button_hover_color" in kwargs:
            self._button_hover_color = self._check_color_type(
                kwargs.pop("button_hover_color")
            )
            require_redraw = True

        if "border_color" in kwargs:
            self._border_color = self._check_color_type(
                kwargs.pop("border_color"), transparency=True
            )
            require_redraw = True
        ...
        if "variables" in kwargs:
            if self._variables is not None:
                ...
                self._variables[0].trace_remove(
                    "write", self._variable_callback_name[0]
                )
                self._variables[1].trace_remove(
                    "write", self._variable_callback_name[1]
                )
